...
//--------------------------------------------------------------
    public int partitionIt(int left, int right, long pivot)
       {
    	if(DBG)System.out.println("partion("+left+", "+right+", "+pivot+");");
       int leftPtr = left - 1;           // right of first elem
       int rightPtr = right + 1;         // left of pivot
       while(true)
          {
    	  if(DBG)System.out.println("leftPtr="+leftPtr+" rightPtr="+rightPtr);
       ...
       if(DBG)System.out.println("FINAL: leftPtr="+leftPtr+" rightPtr="+rightPtr);
...
//--------------------------------------------------------------
   public void swap(int dex1, int dex2)  // swap two elements
      {
      long temp;
      if(DBG)System.out.println("swap("+dex1+", "+dex2+");");
...
class PartitionApp
   ...
   public static void main(String[] args)
      ...
      int size = arr.size();
                                    // partition array
      int partDex = arr.partitionIt(0, size-2, pivot);
